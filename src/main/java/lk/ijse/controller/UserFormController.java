...
public class UserFormController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        for (int i = 0; i < allBooks.size(); i++) {
            ...
            try {
                Parent parent = FXMLLoader.load(getClass().getResource("/my/view/bookOBJ.fxml"));
    ...
    void settingOnAction(ActionEvent event) throws IOException {
        pageControl.popUpWindow("/my/view/userSettingForm.fxml");
    }

    @FXML
    void userHistoryOnAction(ActionEvent event) throws IOException {
        pageControl.popUpWindow("/my/view/historyForm.fxml");
    }
}
