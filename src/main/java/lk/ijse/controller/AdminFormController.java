...
public class AdminFormController implements Initializable {
    ...
    public void logoutOnAction(ActionEvent event) throws IOException {
        ...
        pageControl.popUpWindow("/my/view/loginForm.fxml");
    }

    @FXML
    public void settingOnAction(ActionEvent event) throws IOException {
        pageControl.popUpWindow("/my/view/adminSettingForm.fxml");
    }

    @FXML
    public void historyOnAction(ActionEvent event) throws IOException {
        pageControl.popUpWindow("/my/view/adminHistoryForm.fxml");
    }

    @FXML
    void branchOnAction(ActionEvent event) throws IOException {
        pageControl.popUpWindow("/my/view/branchForm.fxml");
    }

    @FXML
    void bookOnAction(ActionEvent event) throws IOException {
        pageControl.popUpWindow("/my/view/bookForm.fxml");
    }
